...
resources, conversion, validation, execution, help output, and configuration files.
Plugins, nested subcommands, shell completion, and a standard executable runtime remain
